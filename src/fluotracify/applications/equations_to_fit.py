"""FCS fit equation.
    This module copies functions of Dominic Waithe's nanosimpy package
    https://github.com/dwaithe/nanosimpy. Reformatting by aseltmann.
