...
A script which allows to print the last 32 lines of output from the tmux session
...
Start kernel according to [[*Setting starting a jupyter kernel from a remote jupyter session using =emacs-jupyter= in =org babel=][this recipe.]]
...
TOO SLOW! Investigate Error below...
...
|                   |                                      |           |                          |         |    |     |      |    |       |        |
| sh-5.0$           | ye53nis@ara-login01.rz.uni-jena.de's | password: |                          |         |    |     |      |    |       |        |
| Warning:          | Permanently                          | added     | 'node308,192.168.194.53' | (ECDSA) | to | the | list | of | known | hosts. |
...
RAM total: 199G, RAM used: 2.1G, RAM free: 187G
the current directory: /home/ye53nis
My disk usage:
Filesystem         Size  Used Avail Use% Mounted on
...
nfs01-ib:/home      80T   57T   24T  72% /home
